...
SITE_NAME_DEFAULT = 'Beagleboard IDE'
...
IDE_TRACK_DEFAULT = False
IDE_TRACK_CODE_DEFAULT = """
<script type="text/javascript">
  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-33772548-4']);
  _gaq.push(['_setDomainName', 'beagleide.com']);
...
BG_IMG = getattr(settings, 'BG_IMG', 'ide/img/beagle.jpg')

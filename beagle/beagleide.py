...
sys.path.insert(0, os.path.normpath(os.path.join(PATH, "depends")))
...
if __name__ == "__main__":
  parser = argparse.ArgumentParser(description='Beagleboard IDE built in Web Server')
